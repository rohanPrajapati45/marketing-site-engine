    ...
    >
      {step === 1 ? (
        <div className="space-y-5">
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0">
                      <p
                        className={`text-sm font-medium ${selectedType === t.value ? "text-[var(--accent)]" : "text-[var(--text-primary)]"}`}
                      >
                        {t.label}
                      </p>
          ...
          {selectedType === "content-blog" && (
            <div className="rounded-xl border border-dashed border-[var(--border)] bg-[var(--bg)]/40 px-4 py-3">
              <p className="text-sm font-medium text-[var(--text-primary)]">
                Blog section
              </p>
              <p className="text-xs text-[var(--text-muted)] mt-1">
                This section is created empty. Blog management happens inside
                the section editor.
              </p>
            </div>
          )}
        ...
        <div className="space-y-5">
          ...
          <div className="flex items-center gap-3 p-3 bg-[var(--bg)] rounded-xl border border-[var(--border)]">
            ...
            {selectedCardType && (
              <span className="ml-auto px-2 py-0.5 bg-sky-500/10 text-sky-400 rounded-md text-xs font-medium">
                {selectedCardType}
              </span>
            )}
          </div>
          ...
          {schema.length > 0 ? (
            ...
            <p className="text-sm text-[var(--text-muted)] text-center py-4">
              No additional data needed for this section type.
            </p>
          )}
