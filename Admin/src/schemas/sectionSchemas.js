...
export const sectionSchemas = {
  "hero-section": [
    ...
    { name: "videoUrl", type: "text", label: "Background Video URL", placeholder: "/videos/hero.mp4" },
    { name: "showreelGif", type: "text", label: "Showreel Preview GIF", placeholder: "/images/tedmob-gif.gif" },
    { name: "showreelVideo", type: "text", label: "Showreel Video URL", placeholder: "/videos/showreel.mp4" },
  ...
  "project-section": [
    ...
    { name: "clientLogo", type: "text", label: "Client Logo URL", placeholder: "/images/logos/logo4.png" },
    ...
    { name: "mockupImage", type: "text", label: "Mockup Image URL", placeholder: "/images/page4.jpg" },
  ...
  "solution-section": [
    ...
    { name: "images", type: "array", label: "Images (URLs)", itemType: "text", placeholder: "/images/solutions/img.jpg" },
