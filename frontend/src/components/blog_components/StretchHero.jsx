...
function StretchHero() {
  ...
  const [height, setHeight] = useState(window.innerHeight * 0.72);
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      setHeight(window.innerHeight * 0.72 + progress * 260);
    };
  ...
  return (
    <section ref={sectionRef} className="relative h-[72vh] overflow-hidden">
      {/* Background Image */}
      <img
      ...
      <div
        ...
        "
      >
        <div className="w-full px-5 md:px-10 lg:px-16 pb-8 md:pb-12">
          <div className="max-w-5xl">
            <h1 className="text-white text-3xl md:text-5xl lg:text-6xl leading-tight font-[300]">
